...
const Button = ({ text }) => {
    return (
        <button className='relative inline-flex items-center px-6 md:px-8 lg:px-12 py-2  overflow-hidden  font-normal text-slate-600 border-2 border-[#7BA2AD] rounded-md hover:text-white group hover:bg-gray-50'>
